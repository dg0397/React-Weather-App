export default function getWeatherAPI(latitude,longitude,setState,setStatus){
    ...
    fetch(`https://fcc-weather-api.glitch.me/api/current?lat=${latitude}&lon=${longitude}`)
        .then(data => data.json())
        .then(location => {
            const {coord,name,sys,weather,main,visibility,wind} = location;
            ...
            const detailData = {sunrise,sunset,feels_like,humidity,temp_max,temp_min,visibility,deg,speed,lon,lat}
